package ie.wit.pubspotx.ui.auth
...
import ie.wit.pubspotx.databinding.LoginBinding
import ie.wit.pubspotx.ui.home.Home
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                when (result.resultCode) {
                    RESULT_OK -> {
                        ...
                        Timber.i("PubspotX Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
